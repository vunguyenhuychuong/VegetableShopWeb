...
public class MainController extends HttpServlet {
    ...
    private static final String DELETE_CONTROLLE = "DeleteController";
    ...
    private static final String LOGINGG="LoginGG";
    private static final String LOGINGOOGLE_CONTROLLER="LoginGoogleHandler";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Errot at MainController!" + e.toString());
        } finally {
